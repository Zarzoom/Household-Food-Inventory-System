...
public class ItemRepository
{
    ...
    ///     If either the Generic Name or Brand contain the string regardless of case, the method will return the matching item
    ///     or items.
    /// </summary>
    ...
    /// <summary>
    ///     Sends SQL Query to Database to update the current item entry with the new values assigned to the item. The item
    ///     that needs the update is found using the primary key.
    ///     Primary key cannot be updated.
    /// </summary>
    /// <param name="updateMe">
    ///     The Item, updateMe, has the primary key of the item that will be updated in ItemList.
