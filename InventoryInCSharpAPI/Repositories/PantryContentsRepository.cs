...
{
    private readonly ConnectionStringAndOtherSecrets _csos;
    ...
    /// </summary>
    /// <param name="updateMe">
    ///     The PantryContents, updateMe, has the primary key of the PantryContents that will be updated in PantryContents.
    ...
    /// <summary>
    ///     Sends SQL query to the database to find all PantryContents that have an ItemID and PantryID that matches the
    ///     parameter. This method is used in pantry manager by AddToPantry function to make sure that duplicate pantryContents
