...
public class ItemManager
{
    ...
    /// <summary>
    ///     Calls the GetItemList method (returns all Items stored in ItemList) from Item Repository and converts results from
    ///     Task<IEnumerable<Item>> to IEnumerable<Item>.
    /// </summary>
    ...
    /// <summary>
    ///     Calls the FindItemByPrimaryKey method (returns item whose primary key matches the parameter.) from Item Repository
    ///     and converts results
    ...
    ///     FindItemByPrimaryKey for the Item search.
    /// </param>
    ...
    /// <summary>
    ///     Calls the ContainsSearchForGenericNameAndBrand (Searches for an item whose GenericName and/or BrandName contains
    ///     the string that was taken in as a parameter) method from Item Repository.
    ...
    /// <summary>
    ///     Calls the ItemUpdate (updates the item in the database) method from ItemRepository. Converts return from a Task
    ///     <Item> to an Item>
    /// </summary>
    /// <param name="updatedItem">
    ///     Item Object with the same primary key as the Item that needs the update but with edits to
    ///     the other values
    /// </param>
    ...
    ///     Calling DeleteContentsByItem makes sure that all pantryContents that are associated with the Item are deleted
...
/// <summary>
///     Commented out in controller to prevent catastrophic accidents. This method should delete all of the Items from
///     ItemList.
///     There was very little manual testing of this method, and it does not have any integration testing.
/// </summary>
public void DeleteALLItems()
    {
        var allItems = GetItemList();
