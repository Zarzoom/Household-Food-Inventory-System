...
[TestFixture]
public class InsertItemTest: ItemTests
    {
        private Item actualItem = new Item();
        private Item responseItem = new Item();
        private IEnumerable<Item> actual = new List<Item>();
        private List<Item> expected = new List<Item>();
        ...
        [Test]
        public void itemsBrandCorrect()
        {
            Assert.AreEqual(expectedItem.brand, actualItem.brand);
        }
    
        [Test]
        public void itemsGenericNameCorrect()
        {
