TODO: 
Make it so that add Item to pantry button is on screen without having to scroll. The UX design is terrible right now. 
...
show quantity that is in house on item page?
number of items in pantry on pantry content (as tooltip?).
